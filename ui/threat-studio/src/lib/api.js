...
export const STUDIO_API = '/extensions/cloud-apim/extensions/waf/studio';
export const EXT_API = '/extensions/cloud-apim/extensions/waf';
export const ADMIN_API = '/bo/api/proxy';
export const ENTITIES_API = '/bo/api/proxy/apis/waf.extensions.cloud-apim.com/v1';
